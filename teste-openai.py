...
response = client.chat.completions.create(
  ...
  model="gpt-4o",
  messages=[
    {"role": "user", "content": """ Você é um assistente de previsão de séries temporais encarregado de analisar dados de uma série temporal específica.
